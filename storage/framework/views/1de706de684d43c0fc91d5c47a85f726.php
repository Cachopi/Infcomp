<?php $__env->startSection('show_factura'); ?>
    ...
    <div class="container mx-auto">
      <?php if (\Illuminate\Support\Facades\Blade::check('role', 'Admin')): ?>  <h1 class="text-2xl font-bold mb-4">Detalles de la factura <?php echo e($factura->id); ?></h1><?php endif; ?>
        <?php if (\Illuminate\Support\Facades\Blade::check('role', 'Usuario')): ?>  <h1 class="text-2xl font-bold mb-4">Detalles de la factura </h1><?php endif; ?>
...
<?php echo $__env->make('inicio.inicio', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DAW\proyecto 2daw\Infcomp\resources\views/facturas/show.blade.php ENDPATH**/ ?>