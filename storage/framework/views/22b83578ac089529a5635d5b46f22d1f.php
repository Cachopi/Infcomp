...
<?php endif; ?>
<main class="flex justify-center items-center flex-col  m-40 " >


    <!-- Section: Design Block -->
    <section class="background-radial-gradient mb-40 w-[80%] ">
        <style>
            ...
            <div class="w-100 mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
                <div class="grid items-center gap-12 lg:grid-cols-2">
                    ...
                    <div class="mb-12 lg:mb-0">
                        <img src="<?php echo e(asset('images/pc.png')); ?>"
                             class="w-full rounded-lg  dark:shadow-black/20" alt="" />
                    </div>
...
<?php /**PATH D:\DAW\proyecto 2daw\Infcomp\resources\views/index.blade.php ENDPATH**/ ?>